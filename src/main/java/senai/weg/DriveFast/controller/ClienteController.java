...
public class ClienteController {
    ...
    @PostMapping
    public ResponseEntity<ClienteResponse> cadastrar(@RequestBody ClienteRequest dto) {
        ClienteResponse response = clienteService.create(dto);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ClienteResponse> atualizar(@PathVariable Long id, @RequestBody ClienteRequest dto) {
        ClienteResponse response = clienteService.atualizar(id, dto);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<List<ClienteGastoProjection>> relatorioGastos() {
        List<ClienteGastoProjection> response = clienteService.relatorioGastos();
        return ResponseEntity.ok(response);
    }
}
